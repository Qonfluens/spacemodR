...
contaminant exposure to build complex “spacemodels” linking geographic
...
To git track big files, we use `git lfs`. Before using `git add` for a
specifi file, we have to `git lfs track` it like this:
