...
sf_metaleurop_2010 <- sf::read_sf("raw_data/sf_metaleurop_2006_2010.gpkg")
sf_metaleurop_2025 <- sf::read_sf("raw_data/sf_metaleurop_2025.gpkg")
```
...
load("raw_data/fit_direct_cd.rda")
```
...
load("raw_data/fit_direct_b100_cd.rda")
```
