...
Important:
After this step: concentration in soil, plant and earthworm are log10 scaled ppm, while concentration
in beetle, mammal and birds are in ppm.
...
The `foraging_kernels` list provided to the `transfer()` function specifically defines this foraging range: it allows the model to scan the surrounding pixels and average the contamination of the ingested prey.
