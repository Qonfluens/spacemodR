...
```{r plot_full_trophic_FIRbw_norm_target}
...
```{r fluxes_trophic_soil_organism, eval=FALSE}
# 2. Define the transfer equations (Bioaccumulation / Bioconcentration Factors)
fluxes <- fluxes |>
  # beetle
...
We asssume foragning kernel are the same as the dispersal (habitat) kernels
