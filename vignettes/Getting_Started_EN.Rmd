...
Everything starts with geography. `spacemodR` facilitates the extraction and manipulation of land cover data (like the OCS-GE database in France) for a given Region of Interest (ROI).
...
* 🛠️ **Habitat Layer Management**: Build complex habitat and resistance maps from vector geometries.
* 🛠️ **Landscape Connectivity**: Integrate circuit theory (Omniscape) to model the movement of large mammals.
