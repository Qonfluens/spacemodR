...
Tout commence par la géographie. `spacemodR` facilite l'extraction et la manipulation de données d'occupation du sol (comme la base OCS-GE en France) pour une zone d'intérêt (Region of Interest - ROI).
...
* 🛠️ **Habitat Layer Management** : Construire des cartes de résistance et d'habitats complexes depuis des vecteurs.
