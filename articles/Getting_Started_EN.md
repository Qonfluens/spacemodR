...
intakes <- intake(spcmdl_dispersal,
  "soil -> plant" = ~ 10^x / 32,      # Specific equation for plants
  "plant -> herbivore" = 0.5,         # Simple transfer factor for the herbivore
  "herbivore -> carnivore" = 0.8,     # Simple transfer factor for the carnivore
  default = 1
)
