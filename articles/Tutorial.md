...
test_fluxes <- flux(spcmdl_dispersal, default = 1) |>
  ...
  # General rule: sp12 uptake with factor 0.1 (applies to ALL links to sp12)
  add_flux(to = "sp12", value = 0.1) |>
  # Exception: when sp12 feeds on sp10, it's a square function (overwrites the general rule above)
