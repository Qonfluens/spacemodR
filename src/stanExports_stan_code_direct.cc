...
#include "stanExports_stan_code_direct.h"

RCPP_MODULE(stan_fit4stan_code_direct_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_stan_code_direct")
