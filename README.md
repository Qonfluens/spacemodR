...
### Note about tracking big files with git

To git track big files, we use `git lfs`. Before using `git add` for a specifi file,
we have to `git lfs track` it like this:
